...
const featuredNotes = [
  {
    ...
    subject: "Mathematics",
    description:
      "Comprehensive coverage of limits, derivatives, integrals and their applications.",
  ...
  },
  {
    ...
    subject: "Biology",
    description:
      "Deep dive into cellular structures, DNA replication, and protein synthesis.",
    author: "Dr. Alex Chen",
    rating: 4.9,
    downloads: 4.8,
    pages: 95,
  ...
  },
  {
    ...
    subject: "Chemistry",
    description:
      "Key concepts in bonding, reactions, and mechanisms with solved examples.",
  ...
  },
  {
    ...
    subject: "Physics",
    description:
      "Step-by-step solutions to complex physics problems and real-world applications.",
  ...
  },
  {
    ...
    subject: "English",
    description:
      "Complete summaries and analysis of classic and modern literary works.",
  ...
  },
  {
    ...
    subject: "History",
    description:
      "Interactive timeline covering major events, civilizations, and turning points.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8">
              Discover perfectly organized study materials, notes, and resources
              curated by experts. Learn smarter, not harder.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore thousands of notes and study materials organized by
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subjects.map((subject, index) => (
              ...
              >
                <div
                  className={`bg-gradient-to-r ${subject.color} h-24 flex items-center justify-center text-5xl`}
                >
                  {subject.icon}
                </div>
                <div className="p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Handpicked notes and resources from top educators, verified and
              rated by students
            </p>
            ...
            {[
              {
                ...
                description:
                  "All notes are meticulously organized by subject and topic for easy navigation",
                icon: "📂",
              },
              {
                title: "Expert Curated",
                description:
                  "Content verified and curated by experienced educators and top students",
                icon: "✨",
              },
              {
                title: "High Quality PDFs",
                description:
                  "Professionally formatted notes with clear diagrams, tables, and examples",
                icon: "📄",
              },
              {
                title: "Community Rated",
                description:
                  "Every note is rated by thousands of students - use the best ones",
                icon: "⭐",
              },
              {
                title: "Frequently Updated",
                description:
                  "New notes and materials added daily to match latest syllabi",
                icon: "🔄",
              },
              {
                title: "100% Free Access",
                description:
                  "Download and access all study materials without any hidden costs",
                icon: "🎁",
              },
            ].map((feature, index) => (
              <div
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-purple-600 to-cyan-500 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of students who are already using StudyHub to improve
            their grades and master their subjects.
          </p>
